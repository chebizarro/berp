...
namespace Berp.BerpGrammar {
    ...
    public class Parser
    {
        ...
        public Berp.RuleSet Parse(ITokenScanner tokenScanner, ITokenMatcher? tokenMatcher = null, IAstBuilder? astBuilder = null) {
            ...
            context.Builder = astBuilder;
            context.TokenQueue = new Queue<Token>();
            context.Errors = new List<ParserException>();
